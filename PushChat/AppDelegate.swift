...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    let appID = "N2aksV1jywajiRKOV92u42Scz3Q5RGFmOuW6Iwtx";
    let clientKey = "vfmxpQWtEIsweuTYGOC18dssmifgznEVTelzi8NS";
...
//        self.pushnotificationController = PushNotificationController();
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("PushChat", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("PushChat.sqlite")
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject]){
        ...
        AppMessenger.send(notification["aps"] as NSDictionary);
